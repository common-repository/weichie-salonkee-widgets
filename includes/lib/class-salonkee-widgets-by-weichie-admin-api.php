 ...
 * Admin API class.
 */
class Salonkee_Widgets_by_Weichie_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'weichie-salonkee-widgets' ) . '" data-uploader_button_text="' . __( 'Use image', 'weichie-salonkee-widgets' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'weichie-salonkee-widgets' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'weichie-salonkee-widgets' ) . '" />' . "\n";
	...
	public function display_meta_box_field( $field = array(), $post = null ) {
		...
		echo wp_kses($field, $this->allowed_html);
	}
